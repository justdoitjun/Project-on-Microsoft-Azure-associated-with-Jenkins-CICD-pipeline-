    ...
    <div class="mcontainer">
        ...
        <div class="bg-white max-w-4xl mx-auto md:p-10 p-6 relative rounded-md shadow">
            ...
            <div class="md:space-y-6 space-y-4 text-gray-400 md:text-lg">
                ...
                <div class="md:leading-8 leading-7"> 2023년 12월 15일 </div>
                <div class="font-semibold md:text-2xl text-xl text-gray-700"> 행장 특별 담화문 </div>
                <div class="md:leading-8 leading-7"> 발신 : 은행장 </div>
